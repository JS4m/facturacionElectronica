...
operaciones($accion); //llamo la ejecuion de la funcion operaciones con el parametro enviado desde el FORM O vista
    ...
    switch ($accion) {
        ...
        case 'GUARDAR_VENTA':
            ...
            if($comprobante['tipodoc']=='01'){
                $generadoXML->CrearXMLFactura($ruta.$nombre, $emisor, $cliente, $comprobante, $detalle, $cuotas);
