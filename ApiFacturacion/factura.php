...
$comprobante = array(
    'tipodoc'                   =>  '01', //FA:01, BV:03, NC:07, ND:08 Catálogo No. 01: Código de Tipo de documento
    'serie'                     =>  'FACT',
    'correlativo'               =>  '29',
...
//PAS0 01 - CREAR XML DE FACTURA INICIO
...
$xml->CrearXMLFactura($ruta, $emisor, $cliente, $comprobante, $detalle, $cuotas);
echo 'PASO 01: XML DE FACTURA CREADO EXITOSAMENTE..';

//PAS0 01 - CREAR XML DE FACTURA - FIN
